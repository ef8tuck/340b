...
CREATE OR REPLACE VIEW V_DELIVERY_DOCUMENT_01 AS 
...
FROM {coreDBName}.{coreSchemaName}.T_PHS_AUDIT AS T_PHS_AUDIT LEFT JOIN {coreDBName}.{coreSchemaName}.T_CONTRACTPHARMACY_EXCEPTIONS AS COEX ON T_PHS_AUDIT.CONTRACT_PHARMACY_RETAIL = COEX.Retail_Chain
...
CREATE OR REPLACE VIEW V_DELIVERY_DOCUMENT_CP_PAYS_BILL_02 AS 
...
FROM {coreDBName}.{coreSchemaName}.T_PHS_AUDIT AS T_PHS_AUDIT INNER JOIN {coreDBName}.{coreSchemaName}.T_ContractPharmacy_Exceptions AS COEX ON T_PHS_AUDIT.CONTRACT_PHARMACY_RETAIL = COEX.Retail_Chain
