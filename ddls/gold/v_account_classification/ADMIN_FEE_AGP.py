...
--Need to found the input source table
...
FROM {coreDBName}.{coreSchemaName}.T_PHS_Accounts_Generics AS T_PHS_Accounts_Generics
...
IFF(V_PHS_Accounts_Generics_Duplicates_01.Accounts is null,'','Yes') AS Duplicate
FROM ({coreDBName}.{coreSchemaName}.T_PHS_Accounts_Generics AS T_PHS_Accounts_Generics INNER JOIN psas_di_dev.340b_brnz.T_PHS_AUDIT AS T_PHS_AUDIT ON T_PHS_Accounts_Generics.Accounts = T_PHS_AUDIT.CUST_ACCT_ID) LEFT JOIN V_PHS_Accounts_Generics_Duplicates_01 ON T_PHS_AUDIT.CUST_ACCT_ID = V_PHS_Accounts_Generics_Duplicates_01.Accounts
