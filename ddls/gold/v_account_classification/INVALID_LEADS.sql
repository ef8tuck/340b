...
CREATE OR REPLACE VIEW V_NON_APEXUS_CODING_WITH_APEXUS_LEADS_01 AS 
...
FROM {interDBName}.{interSchemaName}.T_MT_ACCOUNT_LIST AS MTACLST INNER JOIN {interDBName}.{interSchemaName}.T_DMEM_LIST  AS  DMLST ON MTACLST.CUST_ACCT_ID =  DMLST.CUST_ACCT_ID INNER JOIN {coreDBName}.{coreSchemaName}.T_PHS_AUDIT AS PHAUD ON MTACLST.CUST_ACCT_ID = PHAUD.CUST_ACCT_ID INNER JOIN {interDBName}.{interSchemaName}.T_MT_LEAD_LIST AS MTLELST ON  DMLST.CNTRCT_LEAD_ID = MTLELST.CNTRCT_LEAD_ID INNER JOIN {coreDBName}.{coreSchemaName}.T_LUTL_PHS_LEADS AS LUPHLEAD ON  DMLST.CNTRCT_LEAD_ID = LUPHLEAD.LEAD LEFT JOIN {interDBName}.{interSchemaName}.T_Tracker AS TRACK ON MTACLST.CUST_ACCT_ID = TRACK.Account
...
CREATE OR REPLACE VIEW V_HRSA_TERMED_WITH_APEXUS_LEADS_02 AS 
...
FROM {interDBName}.{interSchemaName}.T_MT_ACCOUNT_LIST AS MTACLST INNER JOIN {interDBName}.{interSchemaName}.T_DMEM_LIST AS  DMLST ON MTACLST.CUST_ACCT_ID =  DMLST.CUST_ACCT_ID INNER JOIN {coreDBName}.{coreSchemaName}.T_PHS_AUDIT  AS PHAUD ON MTACLST.CUST_ACCT_ID = PHAUD.CUST_ACCT_ID INNER JOIN {interDBName}.{interSchemaName}.T_MT_LEAD_LIST  AS MTLELST ON  DMLST.CNTRCT_LEAD_ID = MTLELST.CNTRCT_LEAD_ID INNER JOIN {coreDBName}.{coreSchemaName}.T_LUTL_PHS_LEADS AS LUPHLEAD  ON  DMLST.CNTRCT_LEAD_ID = LUPHLEAD.LEAD
...
CREATE OR REPLACE VIEW V_OVERRIDE_LEADS_03 AS 
...
FROM {coreDBName}.{coreSchemaName}.T_MT_OVERRIDE_LEAD_LIST AS MTOVLELST INNER JOIN {interDBName}.{interSchemaName}.T_DMEM_LIST AS DMLST ON MTOVLELST.CNTRCT_LEAD_ID = DMLST.CNTRCT_LEAD_ID INNER JOIN {coreDBName}.{coreSchemaName}.T_PHS_AUDIT AS PHAUD ON DMLST.CUST_ACCT_ID = PHAUD.CUST_ACCT_ID LEFT JOIN {interDBName}.{interSchemaName}.T_MT_LEAD_LIST AS MTLELST ON MTOVLELST.CNTRCT_LEAD_ID = MTLELST.CNTRCT_LEAD_ID
...
CREATE OR REPLACE VIEW V_C34_APEXUS_LEADS_04 AS 
SELECT PHAUD.CUST_ACCT_ID, PHAUD.CUST_ACCT_NAME, DMLST.CNTRCT_LEAD_ID, PHAUD.MNC
FROM {coreDBName}.{coreSchemaName}.T_PHS_AUDIT AS PHAUD INNER JOIN {interDBName}.{interSchemaName}.T_DMEM_LIST  AS DMLST ON PHAUD.CUST_ACCT_ID = DMLST.CUST_ACCT_ID INNER JOIN {coreDBName}.{coreSchemaName}.T_LUTL_PHS_LEADS AS LUPHLEAD ON DMLST.CNTRCT_LEAD_ID = LUPHLEAD.LEAD
...
CREATE OR REPLACE VIEW V_APEXUS_MCK_PROGRAMS_05A AS 
...
FROM {interDBName}.{interSchemaName}.T_DMEM_LIST AS DMLST INNER JOIN {coreDBName}.{coreSchemaName}.T_PHS_AUDIT AS PHAUD ON DMLST.CUST_ACCT_ID = PHAUD.CUST_ACCT_ID INNER JOIN {interDBName}.{interSchemaName}.T_MT_Lead_List AS MTLELST ON DMLST.CNTRCT_LEAD_ID = MTLELST.CNTRCT_LEAD_ID
...
CREATE OR REPLACE VIEW V_APEXUS_MCK_PROGRAMS_05B AS 
...
FROM V_APEXUS_MCK_PROGRAMS_05A AS APMCKPR05A LEFT JOIN {coreDBName}.{coreSchemaName}.T_MT_LEAD_INELIGIBLE_LIST AS MTLEINLST ON APMCKPR05A.Lead = MTLEINLST.Lead
...
CREATE OR REPLACE VIEW V_APEXUS_MCK_PROGRAMS_SUMMARY_05C AS 
SELECT APMCKPR05B.Lead, APMCKPR05B.Lead_Name, Count(APMCKPR05B.Account) AS CountOfAccount
FROM V_APEXUS_MCK_PROGRAMS_05B AS APMCKPR05B 
GROUP BY APMCKPR05B.Lead, APMCKPR05B.Lead_Name;

-- COMMAND ----------

CREATE OR REPLACE VIEW V_APEXUS_MCK_PROGRAMS_06 AS 
...
FROM PRD_PSAS_DB.RPT.T_DCON_CONT_ELIG AS E INNER JOIN PRD_PSAS_DB.RPT.T_DM_VSTX_CUST AS V
...
CREATE OR REPLACE VIEW V_PHS_LEADS_07 AS 
...
FROM ({interDBName}.{interSchemaName}.T_DMEM_List AS DMLST INNER JOIN {coreDBName}.{coreSchemaName}.T_PHS_AUDIT AS PHAUD ON DMLST.CUST_ACCT_ID = PHAUD.CUST_ACCT_ID) INNER JOIN {coreDBName}.{coreSchemaName}.T_LUTL_PHS_LEADS AS LUPHLEAD ON DMLST.CNTRCT_LEAD_ID = LUPHLEAD.LEAD
