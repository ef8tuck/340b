...
--Note : V_NON_ORDERING_ACCOUNTS is already created in report 
CREATE OR REPLACE VIEW psas_di_dev.340b_gold.V_APEXUS_ELIGIBILITY_WAC_01 AS
SELECT DISTINCT PHAUD.CUST_ACCT_ID, PHAUD.CUST_ACCT_NAME, PHAUD.MNC, PHAUD.ENTITY_TYPE, PHAUD.ROUTE, PHAUD.PHS_340B_ID, PHAUD.CUST_CHN_ID, PHAUD.CHAIN_NAM, PHAUD.NATIONAL_SUBGRP_CD, PHAUD.NATIONAL_SUBGRP_NAME, PHAUD.PVP_MEMBER_NAME, PHAUD.PVP_PARTICIPATION_FLAG AS PVP_Flag, IFF(CONCAT(ACCT_NAME_A34,ACCT_NAME_PHS)='NY','PHS','WAC') AS Acct_Type, PHAUD.PVP_ELIGIBILITY_DATE AS Apexus_Eligible, PHAUD.PVP_EXPIRATION_DATE, PHAUD.PVP_PARTICIPANT_ID, PHAUD.HRSA_START_DATE, PHAUD.HRSA_TERM_DATE, PHAUD.COMMENTS, PHAUD.STATUS, PHAUD.NATIONAL_GRP_CD
...
ORDER BY IFF(CONCAT(PHAUD.ACCT_NAME_A34,ACCT_NAME_PHS)='NY','PHS','WAC'), PHAUD.CHAIN_NAM;
