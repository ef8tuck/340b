...
FROM psas_di_dev.`340b_brnz`.t_lutl_non_ordering_account AS LUNOORAC LEFT JOIN psas_di_dev.`340b_slvr`.t_phs_audit AS PHAUD ON LUNOORAC.Cust_Acct_ID = PHAUD.CUST_ACCT_ID;
...
FROM psas_di_dev.`340b_slvr`.T_PHS_AUDIT  AS PHAUD LEFT JOIN psas_di_dev.340b_gold.V_NON_ORDERING_ACCOUNTS AS NOORAC ON PHAUD.CUST_ACCT_ID = NOORAC.Cust_Acct_ID
