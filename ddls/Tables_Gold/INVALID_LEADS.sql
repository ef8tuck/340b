...
-- T_tracker missing
CREATE OR REPLACE VIEW psas_di_dev.340b_gold.T_NON_APEXUS_CODING_WITH_APEXUS_LEADS_01 AS 
...
FROM psas_di_dev.340b_slvr.T_MT_ACCOUNT_LIST AS MTACLST INNER JOIN psas_di_dev.340b_slvr.T_DMEM_LIST  AS  DMLST ON MTACLST.CUST_ACCT_ID =  DMLST.CUST_ACCT_ID INNER JOIN psas_di_dev.340b_slvr.T_PHS_AUDIT AS PHAUD ON MTACLST.CUST_ACCT_ID = PHAUD.CUST_ACCT_ID INNER JOIN psas_di_dev.340b_slvr.T_MT_LEAD_LIST AS MTLELST ON  DMLST.CNTRCT_LEAD_ID = MTLELST.CNTRCT_LEAD_ID INNER JOIN psas_di_dev.340b_slvr.T_LUTL_PHS_LEADS AS LUPHLEAD ON  DMLST.CNTRCT_LEAD_ID = LUPHLEAD.LEAD LEFT JOIN psas_di_dev.340b_slvr.T_Tracker AS TRACK ON MTACLST.CUST_ACCT_ID = TRACK.Account
...
CREATE OR REPLACE TABLE  psas_di_dev.340b_gold.T_HRSA_TERMED_WITH_APEXUS_LEADS_02 AS 
...
FROM psas_di_dev.340b_slvr.T_MT_ACCOUNT_LIST AS MTACLST INNER JOIN psas_di_dev.340b_slvr.T_DMEM_LIST AS  DMLST ON MTACLST.CUST_ACCT_ID =  DMLST.CUST_ACCT_ID INNER JOIN psas_di_dev.340b_slvr.T_PHS_AUDIT AS PHAUD ON MTACLST.CUST_ACCT_ID = PHAUD.CUST_ACCT_ID INNER JOIN psas_di_dev.340b_slvr.T_MT_LEAD_LIST AS MTLELST ON  DMLST.CNTRCT_LEAD_ID = MTLELST.CNTRCT_LEAD_ID INNER JOIN psas_di_dev.340b_slvr.T_LUTL_PHS_LEADS AS LUPHLEAD ON  DMLST.CNTRCT_LEAD_ID = LUPHLEAD.LEAD
...
CREATE OR REPLACE TABLE  psas_di_dev.340b_gold.T_OVERRIDE_LEADS_03 AS 
...
FROM psas_di_dev.340b_slvr.T_MT_OVERRIDE_LEAD_LIST AS MTOVLELST INNER JOIN psas_di_dev.340b_slvr.T_DMEM_LIST AS DMLST ON MTOVLELST.CNTRCT_LEAD_ID = DMLST.CNTRCT_LEAD_ID INNER JOIN psas_di_dev.340b_slvr.T_PHS_AUDIT AS PHAUD ON DMLST.CUST_ACCT_ID = PHAUD.CUST_ACCT_ID LEFT JOIN psas_di_dev.340b_slvr.T_MT_LEAD_LIST AS MTLELST ON MTOVLELST.CNTRCT_LEAD_ID = MTLELST.CNTRCT_LEAD_ID
...
CREATE OR REPLACE TABLE  psas_di_dev.340b_gold.T_C34_APEXUS_LEADS_04 AS 
SELECT PHAUD.CUST_ACCT_ID, PHAUD.CUST_ACCT_NAME, DMLST.CNTRCT_LEAD_ID, PHAUD.MNC
FROM psas_di_dev.340b_gold.T_PHS_AUDIT AS PHAUD INNER JOIN psas_di_dev.340b_slvr.T_DMEM_LIST AS DMLST ON PHAUD.CUST_ACCT_ID = DMLST.CUST_ACCT_ID INNER JOIN psas_di_dev.340b_slvr.T_LUTL_PHS_LEADS AS LUPHLEAD ON DMLST.CNTRCT_LEAD_ID = LUPHLEAD.LEAD
WHERE PHAUD.MNC='C34' AND PHAUD.CUST_CHN_ID != '989' AND UPPER(PHAUD.STATUS)='ACTIVE';

-- COMMAND ----------

------------------------------- 05a Q_Apexus_McK_Programs
CREATE OR REPLACE TABLE  psas_di_dev.340b_gold.T_APEXUS_MCK_PROGRAMS_05A AS 
...
FROM psas_di_dev.340b_slvr.T_DMEM_LIST AS DMLST INNER JOIN psas_di_dev.340b_gold.T_PHS_AUDIT AS PHAUD ON DMLST.CUST_ACCT_ID = PHAUD.CUST_ACCT_ID INNER JOIN psas_di_dev.340b_slvr.T_MT_Lead_List AS MTLELST ON DMLST.CNTRCT_LEAD_ID = MTLELST.CNTRCT_LEAD_ID
...
CREATE OR REPLACE TABLE  psas_di_dev.340b_gold.T_APEXUS_MCK_PROGRAMS_05B AS 
...
FROM psas_di_dev.340b_gold.T_APEXUS_MCK_PROGRAMS_05A AS APMCKPR05A LEFT JOIN psas_di_dev.340b_slvr.T_MT_LEAD_INELIGIBLE_LIST AS MTLEINLST ON APMCKPR05A.Lead = MTLEINLST.Lead
...
-------------------------------05c Q_Apexus_McK_Programs_Summary
CREATE OR REPLACE TABLE psas_di_dev.340b_gold.T_APEXUS_MCK_PROGRAMS_SUMMARY_05C AS 
SELECT APMCKPR05B.Lead, APMCKPR05B.Lead_Name, Count(APMCKPR05B.Account) AS CountOfAccount
FROM  psas_di_dev.340b_gold.T_APEXUS_MCK_PROGRAMS_05B AS APMCKPR05B 
GROUP BY APMCKPR05B.Lead, APMCKPR05B.Lead_Name;

-- COMMAND ----------

--tablrs not found so not executed
CREATE OR REPLACE TABLE  psas_di_dev.340b_gold.T_APEXUS_MCK_PROGRAMS_06 AS 
...
FROM PRD_PSAS_DB.RPT.T_DCON_CONT_ELIG AS E INNER JOIN dev_psas_db.rpt.t_dm_vstx_cust AS V
ON E.CUST_ACCT_ID = V.CUST_ACCT_ID
INNER JOIN PRD_PSAS_DB.RPT.T_CMS_LEAD AS L ON E.CNTRCT_LEAD_ID = L.CNTRC_LEAD_ID
INNER JOIN PRD_PSAS_DB.RPT.T_IW_CUST_ACCT AS CA
...
CREATE OR REPLACE TABLE  psas_di_dev.340b_gold.T_PHS_LEADS_07 AS 
...
FROM (psas_di_dev.340b_slvr.T_DMEM_List AS DMLST INNER JOIN psas_di_dev.340b_gold.T_PHS_AUDIT AS PHAUD ON DMLST.CUST_ACCT_ID = PHAUD.CUST_ACCT_ID) INNER JOIN psas_di_dev.340b_slvr.T_LUTL_PHS_LEADS AS LUPHLEAD ON DMLST.CNTRCT_LEAD_ID = LUPHLEAD.LEAD
