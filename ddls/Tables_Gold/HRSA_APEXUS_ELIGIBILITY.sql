...
CREATE OR REPLACE Table psas_di_dev.340b_gold.T_APEXUS_HRSA_TERMED_200 AS 
...
CREATE OR REPLACE TABLE psas_di_dev.340b_gold.T_APEXUS_ELIGIBILITY_WAC_01 AS
SELECT
...
FROM
  psas_di_dev.340b_gold.T_PHS_AUDIT AS PHAUD
  LEFT JOIN psas_di_dev.340b_gold.T_NON_ORDERING_ACCOUNTS AS NOORAC ON PHAUD.CUST_ACCT_ID = NOORAC.Cust_Acct_ID
WHERE
...
CREATE OR REPLACE Table psas_di_dev.340b_gold.T_APEXUS_ELIGIBILITY_PHS_01 AS
