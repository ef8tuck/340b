...
FROM psas_di_dev.340b_slvr.t_lutl_non_ordering_accounts AS LUNOORAC LEFT JOIN psas_di_dev.`340b_gold`.t_phs_audit AS PHAUD ON LUNOORAC.Cust_Acct_ID = PHAUD.CUST_ACCT_ID;


-- COMMAND ----------

CREATE OR REPLACE table psas_di_dev.340b_gold.T_ACCOUNT_CLASSIFICATION_02 AS 
...
FROM psas_di_dev.`340b_gold`.T_PHS_AUDIT  AS PHAUD LEFT JOIN psas_di_dev.340b_gold.T_NON_ORDERING_ACCOUNTS AS NOORAC ON PHAUD.CUST_ACCT_ID = NOORAC.Cust_Acct_ID
