...
CREATE OR REPLACE Table psas_di_dev.340b_gold.T_ACCOUNTCONFIRMATION_LOOKUP_01 AS 
...
FROM psas_di_dev.`340b_slvr`.t_apexusfile AS T_APEXUSFILE LEFT JOIN psas_di_dev.`340b_gold`.T_PHS_AUDIT AS T_PHS_AUDIT ON T_APEXUSFILE.SHIP_TO_ACCT_NO = T_PHS_AUDIT.CUST_ACCT_ID
