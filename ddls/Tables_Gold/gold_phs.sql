...
CREATE TABLE IF NOT EXISTS psas_di_dev.340b_gold.t_phs_audit (
...
) USING DELTA PARTITIONED BY (DATE_PART, HOUR_PART) LOCATION 'abfss://catalog@stpsasdi340bdev.dfs.core.windows.net/gold/T_PHS_AUDIT'
TBLPROPERTIES (
...
INSERT INTO psas_di_dev.340b_gold.t_phs_audit (
  CUST_ACCT_ID,
  CUST_ACCT_NAME,
  ACCT_CLASSIFICATION,
  STATUS,
...
SELECT 
  ...
  FIRST_ORDER,
  LAST_ORDER
FROM psas_di_dev.`340b_brnz`.t_phs_audit;
