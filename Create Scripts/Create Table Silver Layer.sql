...
CREATE TABLE IF NOT EXISTS psas_di_dev.340b_slvr.t_account_mnc_list_invalid (
  CUST_ACCT_ID STRING COMMENT 'CUST_ACCT_ID',
  MNC_CODE STRING COMMENT 'MNC_CODE',
  IS_ACTIVE STRING DEFAULT 'Y' COMMENT 'Indicates if the record is active, default is Y',
  _rescued_data STRING COMMENT 'Rescued Data',
  ...
  DATE_PART DATE GENERATED ALWAYS AS (DATE(RECORD_LOAD_TIME)) COMMENT 'This is autogenerated from date part of the RECORD_LOAD_TIME column',
  HOUR_PART INT GENERATED ALWAYS AS (HOUR(RECORD_LOAD_TIME)) COMMENT 'This is autogenerated from hour part of the RECORD_LOAD_TIME column',
  dq_details ARRAY<ARRAY<STRING>>,
  dq_record_status STRING
) 
USING DELTA PARTITIONED BY (DATE_PART, HOUR_PART) LOCATION 'abfss://catalog@stpsasdi340bdev.dfs.core.windows.net/slvr/t_account_mnc_list_invalid' 
TBLPROPERTIES (
  'delta.feature.allowColumnDefaults' = 'supported',
  'delta.feature.appendOnly' = 'supported',
  'delta.feature.invariants' = 'supported',
...
CREATE TABLE IF NOT EXISTS psas_di_dev.340b_slvr.T_PHS_ACCOUNTS_NON_AGP (
  Accounts STRING,
  _rescued_data STRING COMMENT 'Rescued Data',
  ADF_RUN_ID STRING COMMENT 'ID for specific pipeline run loaded from landing. This run_id gets generated when the records gets loaded from source to landing',
  ADF_JOB_ID STRING COMMENT 'ID of the trigger that invokes the pipeline. This job_id gets generated when the records gets loaded from source to landing',
...
USING DELTA PARTITIONED BY (DATE_PART, HOUR_PART) LOCATION 'abfss://catalog@stpsasdi340bdev.dfs.core.windows.net/slvr/T_PHS_ACCOUNTS_NON_AGP' 
TBLPROPERTIES (
  'delta.feature.allowColumnDefaults' = 'supported',
  'delta.feature.appendOnly' = 'supported',
  'delta.feature.invariants' = 'supported',
...
CREATE TABLE IF NOT EXISTS psas_di_dev.340b_slvr.T_PHS_ACCOUNTS_NON_AGP_INVALID (
  Accounts STRING,
  _rescued_data STRING COMMENT 'Rescued Data',
  ADF_RUN_ID STRING COMMENT 'ID for specific pipeline run loaded from landing. This run_id gets generated when the records gets loaded from source to landing',
  ADF_JOB_ID STRING COMMENT 'ID of the trigger that invokes the pipeline. This job_id gets generated when the records gets loaded from source to landing',
...
USING DELTA PARTITIONED BY (DATE_PART, HOUR_PART) LOCATION 'abfss://catalog@stpsasdi340bdev.dfs.core.windows.net/slvr/T_PHS_ACCOUNTS_NON_AGP_INVALID' 
TBLPROPERTIES (
  'delta.feature.allowColumnDefaults' = 'supported',
  'delta.feature.appendOnly' = 'supported',
  'delta.feature.invariants' = 'supported',
...
CREATE TABLE IF NOT EXISTS psas_di_dev.340b_slvr.t_activestatusupdate_INVALID (
  CUST_ACCT_ID STRING COMMENT 'CUST_ACCT_ID',
  CUST_ACCT_NAME STRING COMMENT 'CUST_ACCT_NAME',
  ACCT_CLASS STRING COMMENT 'ACCT_CLASS',
  STATUS STRING COMMENT 'STATUS',
...
USING DELTA PARTITIONED BY (DATE_PART, HOUR_PART) LOCATION 'abfss://catalog@stpsasdi340bdev.dfs.core.windows.net/slvr/t_activestatusupdate_INVALID' 
TBLPROPERTIES (
 'delta.feature.allowColumnDefaults' = 'supported',
  'delta.feature.appendOnly' = 'supported',
  'delta.feature.invariants' = 'supported',
...
CREATE TABLE IF NOT EXISTS psas_di_dev.340b_slvr.T_CHAINS_INVALID (
  ID STRING COMMENT 'ID',
 CHAIN STRING COMMENT 'CHAIN',
  _rescued_data STRING COMMENT 'Rescued Data',
  ADF_RUN_ID STRING COMMENT 'ID for specific pipeline run loaded from landing. This run_id gets generated when the records gets loaded from source to landing',
...
USING DELTA PARTITIONED BY (DATE_PART, HOUR_PART) LOCATION 'abfss://catalog@stpsasdi340bdev.dfs.core.windows.net/slvr/T_CHAINS_INVALID' 
TBLPROPERTIES (
 'delta.feature.allowColumnDefaults' = 'supported',
  'delta.feature.appendOnly' = 'supported',
  'delta.feature.invariants' = 'supported',
...
CREATE TABLE IF NOT EXISTS psas_di_dev.340b_slvr.t_contractpharmacy_exceptions_INVALID (
  ID STRING COMMENT 'ID',
  RETAIL_CHAIN STRING COMMENT 'RETAIL_CHAIN',
  _rescued_data STRING COMMENT 'Rescued Data',
  ADF_RUN_ID STRING COMMENT 'ID for specific pipeline run loaded from landing. This run_id gets generated when the records gets loaded from source to landing',
...
USING DELTA PARTITIONED BY (DATE_PART, HOUR_PART) LOCATION 'abfss://catalog@stpsasdi340bdev.dfs.core.windows.net/slvr/T_CONTRACTPHARMACY_EXCEPTIONS_INVALID' 
TBLPROPERTIES (
 'delta.feature.allowColumnDefaults' = 'supported',
  'delta.feature.appendOnly' = 'supported',
  'delta.feature.invariants' = 'supported',
...
CREATE TABLE IF NOT EXISTS psas_di_dev.340b_slvr.t_gpo_managers_invalid (
  GPO_NAME STRING COMMENT 'GPO_NAME',
  SENIOR_ACCOUNT_MANAGER STRING COMMENT 'SENIOR_ACCOUNT_MANAGER',
  ACCOUNT_MANAGER_SUPPORT STRING COMMENT 'ACCOUNT_MANAGER_SUPPORT',
  _rescued_data STRING COMMENT 'Rescued Data',
...
USING DELTA PARTITIONED BY (DATE_PART, HOUR_PART) LOCATION 'abfss://catalog@stpsasdi340bdev.dfs.core.windows.net/slvr/t_gpo_managers_invalid' 
TBLPROPERTIES (
 'delta.feature.allowColumnDefaults' = 'supported',
  'delta.feature.appendOnly' = 'supported',
  'delta.feature.invariants' = 'supported',
...
CREATE TABLE IF NOT EXISTS psas_di_dev.340b_slvr.t_luq_account_invalid (
  ID STRING COMMENT 'ID',
  ACCOUNT STRING COMMENT 'ACCOUNT',
  _rescued_data STRING COMMENT 'Rescued Data',
  ADF_RUN_ID STRING COMMENT 'ID for specific pipeline run loaded from landing. This run_id gets generated when the records gets loaded from source to landing',
...
USING DELTA PARTITIONED BY (DATE_PART, HOUR_PART) LOCATION 'abfss://catalog@stpsasdi340bdev.dfs.core.windows.net/slvr/T_LUQ_ACCOUNT_INVALID' 
TBLPROPERTIES (
 'delta.feature.allowColumnDefaults' = 'supported',
  'delta.feature.appendOnly' = 'supported',
  'delta.feature.invariants' = 'supported',
...
CREATE TABLE IF NOT EXISTS psas_di_dev.340b_slvr.t_lutl_entity_INVALID (
  ID STRING COMMENT 'ID',
  ENTITY_TYPE STRING COMMENT 'ENTITY_TYPE',
  ENTITY_NAME STRING COMMENT 'ENTITY_NAME',
  EXPANSION_ENTITY STRING COMMENT 'EXPANSION_ENTITY',
...
USING DELTA PARTITIONED BY (DATE_PART, HOUR_PART) LOCATION 'abfss://catalog@stpsasdi340bdev.dfs.core.windows.net/slvr/T_LUTL_ENTITY_INVALID' 
TBLPROPERTIES (
 'delta.feature.allowColumnDefaults' = 'supported',
  'delta.feature.appendOnly' = 'supported',
  'delta.feature.invariants' = 'supported',
...
CREATE TABLE IF NOT EXISTS psas_di_dev.340b_slvr.T_LUTL_NON_ORDERING_ACCOUNTS_INVALID (
  ID STRING COMMENT 'ID',
  CUST_ACCT_ID STRING COMMENT 'CUST_ACCT_ID',
  CUST_ACCT_NAME STRING COMMENT 'CUST_ACCT_NAME',
  _rescued_data STRING COMMENT 'Rescued Data',
  ...
  dq_details ARRAY<ARRAY<STRING>>,
  dq_record_status STRING
) USING DELTA PARTITIONED BY (DATE_PART, HOUR_PART) LOCATION 'abfss://catalog@stpsasdi340bdev.dfs.core.windows.net/slvr/T_LUTL_NON_ORDERING_ACCOUNTS_INVALID'
TBLPROPERTIES (
  'delta.feature.allowColumnDefaults' = 'supported',
  'delta.feature.appendOnly' = 'supported',
  'delta.feature.invariants' = 'supported',
...
CREATE TABLE IF NOT EXISTS psas_di_dev.340b_slvr.T_LUTL_PHS_LEADS_INVALID (
  ID STRING COMMENT 'ID',
  LEAD STRING COMMENT 'LEAD',
  LEAD_NAME STRING COMMENT 'LEAD_NAME',
  Apexus STRING COMMENT 'Apexus',
  ...
  dq_details ARRAY<ARRAY<STRING>>,
  dq_record_status STRING
) USING DELTA PARTITIONED BY (DATE_PART, HOUR_PART) LOCATION 'abfss://catalog@stpsasdi340bdev.dfs.core.windows.net/slvr/T_LUTL_PHS_LEADS_INVALID'
TBLPROPERTIES (
  'delta.feature.allowColumnDefaults' = 'supported',
  'delta.feature.appendOnly' = 'supported',
  'delta.feature.invariants' = 'supported',
...
CREATE TABLE IF NOT EXISTS psas_di_dev.340b_slvr.t_lutl_pvp_coding_invalid (
  ID STRING COMMENT 'ID',
  CODING STRING COMMENT 'CODING',
  PVP_CODING STRING COMMENT 'PVP_CODING',
  NATL_GRP STRING COMMENT 'NATL_GRP',
...
USING DELTA PARTITIONED BY (DATE_PART, HOUR_PART) LOCATION 'abfss://catalog@stpsasdi340bdev.dfs.core.windows.net/slvr/T_LUTL_PVP_CODING_INVALID'
TBLPROPERTIES (
  'delta.feature.allowColumnDefaults' = 'supported',
  'delta.feature.appendOnly' = 'supported',
  'delta.feature.invariants' = 'supported',
...
CREATE TABLE IF NOT EXISTS psas_di_dev.340b_slvr.t_lutl_sales_admin_invalid (
  ID STRING COMMENT 'ID',
  DC STRING COMMENT 'DC',
  LOCATION STRING COMMENT 'LOCATION',
  REGION STRING COMMENT 'REGION',
  ...
  dq_details ARRAY<ARRAY<STRING>>,
  dq_record_status STRING
) USING DELTA PARTITIONED BY (DATE_PART, HOUR_PART) LOCATION 'abfss://catalog@stpsasdi340bdev.dfs.core.windows.net/slvr/T_LUTL_SALES_ADMIN_INVALID'
TBLPROPERTIES (
  'delta.feature.allowColumnDefaults' = 'supported',
  'delta.feature.appendOnly' = 'supported',
  'delta.feature.invariants' = 'supported',
...
CREATE TABLE IF NOT EXISTS psas_di_dev.340b_slvr.t_mnc_phs_invalid (
  CUSTOMER BIGINT COMMENT 'CUSTOMER',
  MEM STRING COMMENT 'MEM',
  _rescued_data STRING COMMENT 'Rescued Data',
  ADF_RUN_ID STRING COMMENT 'ID for specific pipeline run loaded from landing. This run_id gets generated when the records gets loaded from source to landing',
...
USING DELTA PARTITIONED BY (DATE_PART, HOUR_PART) LOCATION 'abfss://catalog@stpsasdi340bdev.dfs.core.windows.net/slvr/T_MNC_PHS_INVALID' 
TBLPROPERTIES (
  'delta.feature.allowColumnDefaults' = 'supported',
  'delta.feature.appendOnly' = 'supported',
  'delta.feature.invariants' = 'supported',
...
CREATE TABLE IF NOT EXISTS psas_di_dev.340b_slvr.t_mt_lead_ineligible_list_invalid (
  LEAD STRING COMMENT 'LEAD',
  LEAD_NAME STRING COMMENT 'LEAD_NAME',
  COMMENTS STRING COMMENT 'COMMENTS',
  _rescued_data STRING COMMENT 'Rescued Data',
...
USING DELTA PARTITIONED BY (DATE_PART, HOUR_PART) LOCATION 'abfss://catalog@stpsasdi340bdev.dfs.core.windows.net/slvr/T_MT_LEAD_INELIGIBLE_LIST_INVALID' 
TBLPROPERTIES (
  'delta.feature.allowColumnDefaults' = 'supported',
  'delta.feature.appendOnly' = 'supported',
  'delta.feature.invariants' = 'supported',
...
CREATE TABLE IF NOT EXISTS psas_di_dev.340b_slvr.t_mt_override_lead_list_invalid (
  CNTRCT_LEAD_ID STRING COMMENT 'CNTRCT_LEAD_ID',
  LEAD_NAME STRING COMMENT 'LEAD_NAME',
  _rescued_data STRING COMMENT 'Rescued Data',
  ADF_RUN_ID STRING COMMENT 'ID for specific pipeline run loaded from landing. This run_id gets generated when the records gets loaded from source to landing',
...
USING DELTA PARTITIONED BY (DATE_PART, HOUR_PART) LOCATION 'abfss://catalog@stpsasdi340bdev.dfs.core.windows.net/slvr/T_MT_OVERRIDE_LEAD_LIST_INVALID' 
TBLPROPERTIES (
  'delta.feature.allowColumnDefaults' = 'supported',
  'delta.feature.appendOnly' = 'supported',
  'delta.feature.invariants' = 'supported',
...
CREATE TABLE IF NOT EXISTS psas_di_dev.340b_slvr.t_mt_pvp_report_parentmatch_invalid (
  PVP_340B_ID STRING COMMENT 'PVP_340B_ID',
	PVP_MEMBER_NAME STRING COMMENT 'PVP_MEMBER_NAME',
	PVP_PARTICIPANT_ID INTEGER COMMENT 'PVP_PARTICIPANT_ID',
	PVP_PARTICIPATION_FLAG STRING COMMENT 'PVP_PARTICIPATION_FLAG',
...
USING DELTA PARTITIONED BY (DATE_PART, HOUR_PART) LOCATION 'abfss://catalog@stpsasdi340bdev.dfs.core.windows.net/slvr/T_MT_PVP_REPORT_PARENTMATCH_INVALID' 
TBLPROPERTIES (
  'delta.feature.allowColumnDefaults' = 'supported',
  'delta.feature.appendOnly' = 'supported',
  'delta.feature.invariants' = 'supported',
...
CREATE TABLE IF NOT EXISTS psas_di_dev.340b_slvr.t_nat_grp_invalid (
RUN_DATE DATE,
NAT_GRP STRING,
NAT_SUB_GRP STRING,
CUST_DSTRCT STRING,
...
USING DELTA PARTITIONED BY (DATE_PART, HOUR_PART) LOCATION 'abfss://catalog@stpsasdi340bdev.dfs.core.windows.net/slvr/T_NAT_GRP_INVALID' 
TBLPROPERTIES (
  'delta.feature.allowColumnDefaults' = 'supported',
  'delta.feature.appendOnly' = 'supported',
  'delta.feature.invariants' = 'supported',
...
CREATE TABLE IF NOT EXISTS psas_di_dev.340b_slvr.t_pharmacy_type_data_invalid (
  ID STRING COMMENT 'ID',
  CUST_ACCT STRING COMMENT 'CUST_ACCT',
  CUST_ACCT_NAME STRING COMMENT 'CUST_ACCT_NAME',
  PHS_340BID STRING COMMENT 'PHS_340BID',
  ...
  dq_details ARRAY<ARRAY<STRING>>,
  dq_record_status STRING
) USING DELTA PARTITIONED BY (DATE_PART, HOUR_PART) LOCATION 'abfss://catalog@stpsasdi340bdev.dfs.core.windows.net/slvr/T_PHARMACY_TYPE_DATA_INVALID'
TBLPROPERTIES (
  'delta.feature.allowColumnDefaults' = 'supported',
  'delta.feature.appendOnly' = 'supported',
  'delta.feature.invariants' = 'supported',
...
CREATE TABLE IF NOT EXISTS psas_di_dev.340b_slvr.t_phs_accounts_invalid (
CUST_ACCT_ID BIGINT,
CUST_NAME STRING,
STORE_NUM STRING,
DEA_FAMILY STRING,
...
USING DELTA PARTITIONED BY (DATE_PART, HOUR_PART) LOCATION 'abfss://catalog@stpsasdi340bdev.dfs.core.windows.net/slvr/T_PHS_ACCOUNTS_INVALID' 
TBLPROPERTIES (
  'delta.feature.allowColumnDefaults' = 'supported',
  'delta.feature.appendOnly' = 'supported',
  'delta.feature.invariants' = 'supported',
...
CREATE TABLE IF NOT EXISTS psas_di_dev.340b_slvr.t_phs_accounts_generics_invalid (
  ACCOUNTS STRING COMMENT 'ACCOUNTS',
  _rescued_data STRING COMMENT 'Rescued Data',
  ADF_RUN_ID STRING COMMENT 'ID for specific pipeline run loaded from landing. This run_id gets generated when the records gets loaded from source to landing',
  ADF_JOB_ID STRING COMMENT 'ID of the trigger that invokes the pipeline. This job_id gets generated when the records gets loaded from source to landing',
...
USING DELTA PARTITIONED BY (DATE_PART, HOUR_PART) LOCATION 'abfss://catalog@stpsasdi340bdev.dfs.core.windows.net/slvr/T_PHS_ACCOUNTS_GENERICS_INVALID' 
TBLPROPERTIES (
  'delta.feature.allowColumnDefaults' = 'supported',
  'delta.feature.appendOnly' = 'supported',
  'delta.feature.invariants' = 'supported',
...
CREATE TABLE IF NOT EXISTS psas_di_dev.340b_slvr.T_PHS_AUDIT_INVALID (
  CUST_ACCT_ID STRING COMMENT 'CUST_ACCT_ID',
  CUST_ACCT_NAME STRING COMMENT 'CUST_ACCT_NAME',
  ACCT_CLASSIFICATION STRING COMMENT 'ACCT_CLASSIFICATION',
  STATUS STRING COMMENT 'STATUS',
  ...
  dq_details ARRAY<ARRAY<STRING>>,
  dq_record_status STRING
) USING DELTA PARTITIONED BY (DATE_PART, HOUR_PART) LOCATION 'abfss://catalog@stpsasdi340bdev.dfs.core.windows.net/slvr/T_PHS_AUDIT_INVALID'
TBLPROPERTIES (
  'delta.feature.allowColumnDefaults' = 'supported',
  'delta.feature.appendOnly' = 'supported',
  'delta.feature.invariants' = 'supported',
...
CREATE TABLE IF NOT EXISTS psas_di_dev.340b_slvr.t_pvp_report_invalid (
PVP_PARTICIPANT_ID BIGINT,
PVP_PARTICIPATION_FLAG BOOLEAN,
COMMITTED_LOP_LOCS STRING,
PVP_ENTITY_TYPE STRING,
...
USING DELTA PARTITIONED BY (DATE_PART, HOUR_PART) LOCATION 'abfss://catalog@stpsasdi340bdev.dfs.core.windows.net/slvr/T_PVP_REPORT_INVALID' 
TBLPROPERTIES (
  'delta.feature.allowColumnDefaults' = 'supported',
  'delta.feature.appendOnly' = 'supported',
  'delta.feature.invariants' = 'supported',
...
CREATE TABLE IF NOT EXISTS psas_di_dev.340b_slvr.t_ta_phmmmd_dm_vstx_cust_invalid (
KUNNR_CUST string, 
CUST_ACCT_ID string,
XFD_KU_CK_DGT decimal(38,18),
XFD_KU_BILLING_BLK string,
...
MCK_KU_GOVT_CONTRACT_IND string,
  ...
  dq_details ARRAY<ARRAY<STRING>>,
  dq_record_status STRING
) USING DELTA PARTITIONED BY (DATE_PART, HOUR_PART) LOCATION 'abfss://catalog@stpsasdi340bdev.dfs.core.windows.net/slvr/T_TA_PHMMMD_DM_VSTX_CUST_INVALID'
TBLPROPERTIES (
  'delta.feature.allowColumnDefaults' = 'supported',
  'delta.feature.appendOnly' = 'supported',
  'delta.feature.invariants' = 'supported',
...
CREATE TABLE IF NOT EXISTS psas_di_dev.340b_slvr.t_tpv_invalid (
  ID STRING COMMENT 'ID',
  VENDOR_NAME STRING COMMENT 'VENDOR_NAME',
  TPV STRING COMMENT 'TPV',
  ACCOUNT_MANAGER STRING COMMENT 'ACCOUNT_MANAGER',
  ...
  dq_details ARRAY<ARRAY<STRING>>,
  dq_record_status STRING
) USING DELTA PARTITIONED BY (DATE_PART, HOUR_PART) LOCATION 'abfss://catalog@stpsasdi340bdev.dfs.core.windows.net/slvr/T_TPV_INVALID'
TBLPROPERTIES (
  'delta.feature.allowColumnDefaults' = 'supported',
  'delta.feature.appendOnly' = 'supported',
  'delta.feature.invariants' = 'supported',
...
CREATE TABLE IF NOT EXISTS psas_di_dev.340b_slvr.t_apexus_code_key_invalid (
    LEAD_NO BIGINT,
    CODE_KEY BIGINT,
    ORG_ID_SEQ STRING,
    CONTRACT_NAME STRING,
...
USING DELTA PARTITIONED BY (DATE_PART, HOUR_PART) LOCATION'abfss://catalog@stpsasdi340bdev.dfs.core.windows.net/slvr/T_APEXUS_CODE_KEY_INVALID'  
TBLPROPERTIES (
  'delta.feature.allowColumnDefaults' = 'supported',
  'delta.feature.appendOnly' = 'supported',
  'delta.feature.invariants' = 'supported',
...
CREATE TABLE IF NOT EXISTS psas_di_dev.340b_slvr.T_APEXUS_PHS_ACCT_BY_LEAD_INVALID (
    LEAD_NO BIGINT,
    CODE_KEY BIGINT,
    ORG_ID_SEQ STRING,
    CONTRACT_NAME STRING,
...
USING DELTA PARTITIONED BY (DATE_PART, HOUR_PART) LOCATION 'abfss://catalog@stpsasdi340bdev.dfs.core.windows.net/slvr/T_APEXUS_PHS_ACCT_BY_LEAD_INVALID' 
TBLPROPERTIES (
  'delta.feature.allowColumnDefaults' = 'supported',
  'delta.feature.appendOnly' = 'supported',
  'delta.feature.invariants' = 'supported',
...
CREATE TABLE IF NOT EXISTS psas_di_dev.340b_slvr.T_APEXUS_WAC_ACCT_BY_LEAD_INVALID (
    LEAD_NO BIGINT,
    CODE_KEY STRING,
    ORG_ID_SEQ STRING,
    CONTRACT_NAME STRING,
...
USING DELTA PARTITIONED BY (DATE_PART, HOUR_PART) LOCATION 'abfss://catalog@stpsasdi340bdev.dfs.core.windows.net/slvr/T_APEXUS_WAC_ACCT_BY_LEAD_INVALID' 
TBLPROPERTIES (
  'delta.feature.allowColumnDefaults' = 'supported',
  'delta.feature.appendOnly' = 'supported',
  'delta.feature.invariants' = 'supported',
...
CREATE TABLE IF NOT EXISTS psas_di_dev.340b_slvr.t_apexusfile_invalid (
  ID STRING COMMENT 'ID',
  APEXUS_340B_ID STRING COMMENT 'APEXUS_340B_ID',
  ENTITY_NAME STRING COMMENT 'ENTITY_NAME',
  SHIP_TO_ACCT_NAME STRING COMMENT 'SHIP_TO_ACCT_NAME',
...
USING DELTA PARTITIONED BY (DATE_PART, HOUR_PART) LOCATION 'abfss://catalog@stpsasdi340bdev.dfs.core.windows.net/slvr/T_APEXUSFILE_INVALID' 
TBLPROPERTIES (
  'delta.feature.allowColumnDefaults' = 'supported',
  'delta.feature.appendOnly' = 'supported',
  'delta.feature.invariants' = 'supported',
...
CREATE TABLE IF NOT EXISTS psas_di_dev.340b_slvr.T_PHS_MEMBERSHIPROSTER_WAC_INVALID (
CUST_ACCT_ID STRING,
CUST_NAME STRING,
340B_ID STRING,
PVP_PARTICIPANT_ID STRING,
...
USING DELTA PARTITIONED BY (DATE_PART, HOUR_PART) LOCATION 'abfss://catalog@stpsasdi340bdev.dfs.core.windows.net/slvr/T_PHS_MEMBERSHIPROSTER_WAC_INVALID' 
TBLPROPERTIES (
  'delta.feature.allowColumnDefaults' = 'supported',
  'delta.feature.appendOnly' = 'supported',
  'delta.feature.invariants' = 'supported',
...
CREATE TABLE IF NOT EXISTS psas_di_dev.340b_slvr.t_iw_cust_acct_invalid (
CUST_ACCT_ID string,
CUST_NUM string,
CUST_BUS_TYP_CD string,
SLS_TERR_ID string,
...
DEA_NUM_SH string,
  ...
  dq_details ARRAY<ARRAY<STRING>>,
  dq_record_status STRING
) USING DELTA PARTITIONED BY (DATE_PART, HOUR_PART) LOCATION 'abfss://catalog@stpsasdi340bdev.dfs.core.windows.net/slvr/T_IW_CUST_ACCT_INVALID'
TBLPROPERTIES (
  'delta.feature.allowColumnDefaults' = 'supported',
  'delta.feature.appendOnly' = 'supported',
  'delta.feature.invariants' = 'supported',
...
CREATE TABLE IF NOT EXISTS   psas_di_dev.340b_slvr.T_MPB_PHS_WAC (
	CUSTOMER BIGINT,
	COCD BIGINT,
	DATE DATE,
	NAME_1 STRING,
  ...
  DATE_PART DATE GENERATED ALWAYS AS (DATE(RECORD_LOAD_TIME)) COMMENT 'This is autogenerated from date part of the RECORD_LOAD_TIME column',
  HOUR_PART INT GENERATED ALWAYS AS (HOUR(RECORD_LOAD_TIME)) COMMENT 'This is autogenerated from hour part of the RECORD_LOAD_TIME column'
) USING DELTA PARTITIONED BY (DATE_PART, HOUR_PART) LOCATION 'abfss://catalog@stpsasdi340bdev.dfs.core.windows.net/slvr/T_MPB_PHS_WAC'
TBLPROPERTIES (
  'delta.feature.allowColumnDefaults' = 'supported',
  'delta.feature.appendOnly' = 'supported',
  'delta.feature.invariants' = 'supported',
...
CREATE TABLE IF NOT EXISTS   psas_di_dev.340b_slvr.T_MPB_PHS_WAC_INVALID (
	CUSTOMER BIGINT,
	COCD BIGINT,
	DATE DATE,
	NAME_1 STRING,
  ...
  HOUR_PART INT GENERATED ALWAYS AS (HOUR(RECORD_LOAD_TIME)) COMMENT 'This is autogenerated from hour part of the RECORD_LOAD_TIME column',
	dq_details ARRAY<ARRAY<STRING>>,
  dq_record_status STRING
) USING DELTA PARTITIONED BY (DATE_PART, HOUR_PART) LOCATION 'abfss://catalog@stpsasdi340bdev.dfs.core.windows.net/slvr/T_MPB_PHS_WAC_INVALID'
TBLPROPERTIES (
  'delta.feature.allowColumnDefaults' = 'supported',
  'delta.feature.appendOnly' = 'supported',
  'delta.feature.invariants' = 'supported',
...
CREATE TABLE IF NOT EXISTS  psas_di_dev.340b_slvr.T_TRACKER(
ID BIGINT,
PRIMARY_TPV STRING,
ACCT_MANAGER STRING,
TPV_CONTACT STRING,
...
Path STRING,
  ...
  DATE_PART DATE GENERATED ALWAYS AS (DATE(RECORD_LOAD_TIME)) COMMENT 'This is autogenerated from date part of the RECORD_LOAD_TIME column',
  HOUR_PART INT GENERATED ALWAYS AS (HOUR(RECORD_LOAD_TIME)) COMMENT 'This is autogenerated from hour part of the RECORD_LOAD_TIME column'
) USING DELTA PARTITIONED BY (DATE_PART, HOUR_PART) LOCATION 'abfss://catalog@stpsasdi340bdev.dfs.core.windows.net/slvr/T_TRACKER'
TBLPROPERTIES (
  'delta.feature.allowColumnDefaults' = 'supported',
  'delta.feature.appendOnly' = 'supported',
  'delta.feature.invariants' = 'supported',
...
CREATE TABLE IF NOT EXISTS  psas_di_dev.340b_slvr.T_TRACKER_INVALID(
ID BIGINT,
PRIMARY_TPV STRING,
ACCT_MANAGER STRING,
TPV_CONTACT STRING,
...
Path STRING,
  ...
  dq_details ARRAY<ARRAY<STRING>>,
  dq_record_status STRING
) USING DELTA PARTITIONED BY (DATE_PART, HOUR_PART) LOCATION 'abfss://catalog@stpsasdi340bdev.dfs.core.windows.net/slvr/T_TRACKER_INVALID'
TBLPROPERTIES (
  'delta.feature.allowColumnDefaults' = 'supported',
  'delta.feature.appendOnly' = 'supported',
  'delta.feature.invariants' = 'supported',
...
DISTRICT_NAME STRING,
DEA_NUM STRING,
DEA_NUM_EXPIRE TIMESTAMP ,
DEA_FAMILY STRING,
CS_LICENSE STRING,
STATE_PHARMACY_LICENSE_NUM STRING,
STATE_PHARMACY_LICENSE_NUM_EXPIRE TIMESTAMP ,
HIM_NUM STRING,
PHS_340B_ID STRING,
...
ALIAS STRING,
SERVICE_ELIGIBILITY_BEGIN TIMESTAMP ,
SERVICE_ELIGIBILITY_END TIMESTAMP ,
SALES_TERRITORY_ID STRING,
SALESPERSON STRING,
AM_OR_RSM STRING,
VPS_NAME STRING,
...
OTC_BILL_PLAN DOUBLE,
OTC_PROMO_BP STRING,
OTC_PROMO_COG DOUBLE,
CUST_DROP_SHIP_IND STRING,
DROP_SHIP_RX_BILL_ DOUBLE,
DROP_SHIP_OTC_BILL DOUBLE,
...
ROUTE STRING,
STOP STRING,
TOTAL_DELIVERIES DOUBLE,
COGS_DIFF DOUBLE,
NEW_RX_COGS DOUBLE,
NEW_OTC_COGS DOUBLE,
NET_MONTHLY_AVERAG DOUBLE,
...
CREATE TABLE IF NOT EXISTS  psas_di_dev.340b_slvr.T_QUARTERLY_AUDIT_DATA_INVALID(
STATUS STRING,
GPO STRING,
GROUP_NAME STRING,
CHAIN STRING,
...
FREE_REDS_PER_MONT STRING,
  ...
  dq_details ARRAY<ARRAY<STRING>>,
  dq_record_status STRING
) USING DELTA PARTITIONED BY (DATE_PART, HOUR_PART) LOCATION 'abfss://catalog@stpsasdi340bdev.dfs.core.windows.net/slvr/T_QUARTERLY_AUDIT_DATA_INVALID'
TBLPROPERTIES (
  'delta.feature.allowColumnDefaults' = 'supported',
  'delta.feature.appendOnly' = 'supported',
  'delta.feature.invariants' = 'supported',
...
CREATE TABLE IF NOT EXISTS psas_di_dev.340b_slvr.T_MT_PHS_DMEM_INVALID(
CUST_ACCT_ID STRING,
LEAD STRING,
LEAD_NAME STRING,
EXPANSION_ENTITY STRING,
ENTITY_TYPE STRING,
  ...
  dq_details ARRAY<ARRAY<STRING>>,
  dq_record_status STRING
) USING DELTA PARTITIONED BY (DATE_PART, HOUR_PART) LOCATION 'abfss://catalog@stpsasdi340bdev.dfs.core.windows.net/slvr/T_MT_PHS_DMEM_INVALID'
TBLPROPERTIES (
  'delta.feature.allowColumnDefaults' = 'supported',
  'delta.feature.appendOnly' = 'supported',
  'delta.feature.invariants' = 'supported',
...
CREATE TABLE IF NOT EXISTS psas_di_dev.340b_slvr.T_DMEM_LIST_INVALID(
CUST_ACCT_ID STRING,
CNTRCT_LEAD_ID STRING,
PRTY_CONT STRING,
MARKUP_CONT BIGINT,
...
LEAD_TYPE STRING,
  ...
  dq_details ARRAY<ARRAY<STRING>>,
  dq_record_status STRING
) USING DELTA PARTITIONED BY (DATE_PART, HOUR_PART) LOCATION 'abfss://catalog@stpsasdi340bdev.dfs.core.windows.net/slvr/T_DMEM_LIST_INVALID'
TBLPROPERTIES (
  'delta.feature.allowColumnDefaults' = 'supported',
  'delta.feature.appendOnly' = 'supported',
  'delta.feature.invariants' = 'supported',
...
TBLPROPERTIES (
  ...
  CREATE TABLE IF NOT EXISTS psas_di_dev.340b_slvr.T_MT_WAC_DMEM_INVALID(
CUST_ACCT_ID STRING, 
LEAD STRING, 
LEAD_NAME STRING,
EXPANSION_ENTITY  STRING,
ENTITY_TYPE  STRING,
  ...
  dq_details ARRAY<ARRAY<STRING>>,
  dq_record_status STRING
) USING DELTA PARTITIONED BY (DATE_PART, HOUR_PART) LOCATION 'abfss://catalog@stpsasdi340bdev.dfs.core.windows.net/slvr/T_MT_WAC_DMEM_INVALID'
TBLPROPERTIES (
  'delta.feature.allowColumnDefaults' = 'supported',
  'delta.feature.appendOnly' = 'supported',
  'delta.feature.invariants' = 'supported',
...
CREATE TABLE IF NOT EXISTS psas_di_dev.340b_slvr.T_MT_LEAD_LIST_INVALID(
  CNTRCT_LEAD_ID STRING,
  CNTRCT_LEAD_NAME STRING,
  CNTRCT_LEAD_TYPE STRING,
  _rescued_data STRING
  ...
  dq_details ARRAY<ARRAY<STRING>>,
  dq_record_status STRING
) USING DELTA PARTITIONED BY (DATE_PART, HOUR_PART) LOCATION 'abfss://catalog@stpsasdi340bdev.dfs.core.windows.net/slvr/T_MT_LEAD_LIST_INVALID'
TBLPROPERTIES (
  'delta.feature.allowColumnDefaults' = 'supported',
  'delta.feature.appendOnly' = 'supported',
  'delta.feature.invariants' = 'supported',
...
CREATE TABLE IF NOT EXISTS psas_di_dev.340b_slvr.T_PHS_MEMBERSHIPROSTER_MEMBERS_INVALID(
 CUST_ACCT_ID STRING,
 CUST_NAME STRING,
 PVP_MEMBER_NAME STRING,
 COVERED_ENTITY_PRIMARY STRING,
 ...
 EXTENDED_TO_MPB_YN STRING,
  ...
  dq_details ARRAY<ARRAY<STRING>>,
  dq_record_status STRING
) USING DELTA PARTITIONED BY (DATE_PART, HOUR_PART) LOCATION 'abfss://catalog@stpsasdi340bdev.dfs.core.windows.net/slvr/T_PHS_MEMBERSHIPROSTER_MEMBERS_INVALID'
TBLPROPERTIES (
  'delta.feature.allowColumnDefaults' = 'supported',
  'delta.feature.appendOnly' = 'supported',
  'delta.feature.invariants' = 'supported',
...
CREATE TABLE psas_di_dev.`340b_slvr`.T_COMMENTS (
  ID INT,
  ACCOUNT STRING,
  COMMENTS STRING,
  FOLLOW_UP STRING,
  ZX_BLOCK DATE,
  OPENED_FOR_RETURNS DATE,
  _rescued_data STRING COMMENT 'Rescued Data',
  ADF_RUN_ID STRING COMMENT 'ID for specific pipeline run loaded from landing. This run_id gets generated when the records gets loaded from source to landing',
  ADF_JOB_ID STRING COMMENT 'ID of the trigger that invokes the pipeline. This job_id gets generated when the records gets loaded from source to landing',
  RECORD_LOAD_TIME TIMESTAMP DEFAULT current_timestamp COMMENT 'This is the default generated column using current timestamp when the record is loaded in the table',
  ...
  DATE_PART DATE GENERATED ALWAYS AS (DATE(RECORD_LOAD_TIME)) COMMENT 'This is autogenerated from date part of the RECORD_LOAD_TIME column',
  HOUR_PART INT GENERATED ALWAYS AS (HOUR(RECORD_LOAD_TIME)) COMMENT 'This is autogenerated from hour part of the RECORD_LOAD_TIME column'
) USING DELTA PARTITIONED BY (DATE_PART, HOUR_PART) LOCATION 'abfss://catalog@stpsasdi340bdev.dfs.core.windows.net/slvr/T_COMMENTS'
TBLPROPERTIES (
  'delta.feature.allowColumnDefaults' = 'supported',
  'delta.feature.appendOnly' = 'supported',
  'delta.feature.invariants' = 'supported',
  ...
  CREATE TABLE psas_di_dev.`340b_slvr`.t_comments_invalid (
  ID INT,
  ACCOUNT STRING,
  COMMENTS STRING,
  FOLLOW_UP STRING,
  ...
  dq_details ARRAY<ARRAY<STRING>>,
  dq_record_status STRING
) USING DELTA PARTITIONED BY (DATE_PART, HOUR_PART) LOCATION 'abfss://catalog@stpsasdi340bdev.dfs.core.windows.net/slvr/T_COMMENTS_INVALID'
TBLPROPERTIES (
  'delta.feature.allowColumnDefaults' = 'supported',
  'delta.feature.appendOnly' = 'supported',
  'delta.feature.invariants' = 'supported',
...
CREATE TABLE IF NOT EXISTS psas_di_dev.340b_slvr.T_MT_PVP_REPORT(
PVP_340B_ID STRING,
PVP_MEMBER_NAME STRING,
PVP_PARTICIPANT_ID INTEGER,
PVP_PARTICIPATION_FLAG STRING,
PVP_EFFECTIVE_DATE DATE,
PVP_EXPIRATION_DATE DATE,
...
PVP_STATE STRING,
  ...
  DATE_PART DATE GENERATED ALWAYS AS (DATE(RECORD_LOAD_TIME)) COMMENT 'This is autogenerated from date part of the RECORD_LOAD_TIME column',
  HOUR_PART INT GENERATED ALWAYS AS (HOUR(RECORD_LOAD_TIME)) COMMENT 'This is autogenerated from hour part of the RECORD_LOAD_TIME column'
) USING DELTA PARTITIONED BY (DATE_PART, HOUR_PART) LOCATION 'abfss://catalog@stpsasdi340bdev.dfs.core.windows.net/slvr/T_MT_PVP_REPORT'
TBLPROPERTIES (
  'delta.feature.allowColumnDefaults' = 'supported',
  'delta.feature.appendOnly' = 'supported',
  'delta.feature.invariants' = 'supported',
...
PVP_STATE STRING,
  ...
  dq_details ARRAY<ARRAY<STRING>>,
  dq_record_status STRING
) USING DELTA PARTITIONED BY (DATE_PART, HOUR_PART) LOCATION 'abfss://catalog@stpsasdi340bdev.dfs.core.windows.net/slvr/T_MT_PVP_REPORT_INVALID'
TBLPROPERTIES (
  'delta.feature.allowColumnDefaults' = 'supported',
  'delta.feature.appendOnly' = 'supported',
  'delta.feature.invariants' = 'supported',
...
CREATE TABLE IF NOT EXISTS psas_di_dev.340b_slvr.T_HRSA(
PHS_340B_ID STRING ,
STATE STRING ,
City STRING ,
`DELETE` INTEGER ,
...
HRSA_START_DATE DATE ,
  ...
  DATE_PART DATE GENERATED ALWAYS AS (DATE(RECORD_LOAD_TIME)) COMMENT 'This is autogenerated from date part of the RECORD_LOAD_TIME column',
  HOUR_PART INT GENERATED ALWAYS AS (HOUR(RECORD_LOAD_TIME)) COMMENT 'This is autogenerated from hour part of the RECORD_LOAD_TIME column'
) USING DELTA PARTITIONED BY (DATE_PART, HOUR_PART) LOCATION 'abfss://catalog@stpsasdi340bdev.dfs.core.windows.net/slvr/T_HRSA'
TBLPROPERTIES (
  'delta.feature.allowColumnDefaults' = 'supported',
  'delta.feature.appendOnly' = 'supported',
  'delta.feature.invariants' = 'supported',
...
HRSA_START_DATE DATE ,
  ...
  dq_details ARRAY<ARRAY<STRING>>,
  dq_record_status STRING
) USING DELTA PARTITIONED BY (DATE_PART, HOUR_PART) LOCATION 'abfss://catalog@stpsasdi340bdev.dfs.core.windows.net/slvr/T_HRSA_INVALID'
TBLPROPERTIES (
  'delta.feature.allowColumnDefaults' = 'supported',
  'delta.feature.appendOnly' = 'supported',
  'delta.feature.invariants' = 'supported',
...
CREATE TABLE IF NOT EXISTS psas_di_dev.340b_slvr.T_MT_ACCOUNT_LIST(
CUST_ACCT_ID STRING,
...
_rescued_data STRING COMMENT 'Rescued Data',
  ...
  dq_details ARRAY<ARRAY<STRING>>,
  dq_record_status STRING
) USING DELTA PARTITIONED BY (DATE_PART, HOUR_PART) LOCATION 'abfss://catalog@stpsasdi340bdev.dfs.core.windows.net/slvr/T_MT_ACCOUNT_LIST'
TBLPROPERTIES (
  'delta.feature.allowColumnDefaults' = 'supported',
  'delta.feature.appendOnly' = 'supported',
  'delta.feature.invariants' = 'supported',
  ...
  CREATE TABLE IF NOT EXISTS psas_di_dev.340b_slvr.t_mt_account_list_invalid(
CUST_ACCT_ID STRING,
CUST_ACCT_NAME STRING,
CUST_CHN_ID STRING,
ENTITY_TYPE STRING,
...
_rescued_data STRING COMMENT 'Rescued Data',
  ...
  dq_details ARRAY<ARRAY<STRING>>,
  dq_record_status STRING
) USING DELTA PARTITIONED BY (DATE_PART, HOUR_PART) LOCATION 'abfss://catalog@stpsasdi340bdev.dfs.core.windows.net/slvr/T_MT_ACCOUNT_LIST_INVALID'
TBLPROPERTIES (
  'delta.feature.allowColumnDefaults' = 'supported',
  'delta.feature.appendOnly' = 'supported',
  'delta.feature.invariants' = 'supported',
...
CREATE TABLE IF NOT EXISTS psas_di_dev.340b_slvr.T_MAINLEAD(
CUST_ACCT_ID STRING,
CNTRCT_LEAD_ID STRING,
_rescued_data STRING COMMENT 'Rescued Data',
  ADF_RUN_ID STRING COMMENT 'ID for specific pipeline run loaded from landing. This run_id gets generated when the records gets loaded from source to landing',
  ...
  dq_details ARRAY<ARRAY<STRING>>,
  dq_record_status STRING
) USING DELTA PARTITIONED BY (DATE_PART, HOUR_PART) LOCATION 'abfss://catalog@stpsasdi340bdev.dfs.core.windows.net/slvr/T_MAINLEAD'
TBLPROPERTIES (
  'delta.feature.allowColumnDefaults' = 'supported',
  'delta.feature.appendOnly' = 'supported',
  'delta.feature.invariants' = 'supported',
...
_rescued_data STRING COMMENT 'Rescued Data',
  ...
  dq_details ARRAY<ARRAY<STRING>>,
  dq_record_status STRING
) USING DELTA PARTITIONED BY (DATE_PART, HOUR_PART) LOCATION 'abfss://catalog@stpsasdi340bdev.dfs.core.windows.net/slvr/T_MAINLEAD_INVALID'
TBLPROPERTIES (
  'delta.feature.allowColumnDefaults' = 'supported',
  'delta.feature.appendOnly' = 'supported',
  'delta.feature.invariants' = 'supported',
