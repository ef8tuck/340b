...
CREATE TABLE IF NOT EXISTS psas_di_dev.340b_brnz.t_phs_audit (
  CUST_ACCT_ID STRING COMMENT 'CUST_ACCT_ID',
  CUST_ACCT_NAME STRING COMMENT 'CUST_ACCT_NAME',
  ...
  DATE_PART DATE GENERATED ALWAYS AS (DATE(RECORD_LOAD_TIME)) COMMENT 'This is autogenerated from date part of the RECORD_LOAD_TIME column',
  HOUR_PART INT GENERATED ALWAYS AS (HOUR(RECORD_LOAD_TIME)) COMMENT 'This is autogenerated from hour part of the RECORD_LOAD_TIME column'
) USING DELTA PARTITIONED BY (DATE_PART, HOUR_PART) LOCATION 'abfss://catalog@stpsasdi340bdev.dfs.core.windows.net/brnz/T_PHS_AUDIT'
TBLPROPERTIES (
  'delta.feature.allowColumnDefaults' = 'supported',
  'delta.feature.appendOnly' = 'supported',
  'delta.feature.invariants' = 'supported',
...
--! This script might fail because it uses a field which is variable in sql
CREATE TABLE IF NOT EXISTS  psas_di_dev.340b_brnz.T_TRACKER_TEMP(ID STRING,
PRIMARY_TPV STRING,
ACCT_MANAGER STRING,
TPV_CONTACT STRING,
...
CREATE TABLE IF NOT EXISTS psas_di_dev.340b_brnz.T_MT_PHS_DMEM(
CUST_ACCT_ID STRING,
LEAD STRING,
LEAD_NAME STRING,
...
IS_ACTIVE STRING DEFAULT 'Y' COMMENT 'Indicates if the record is active, default is Y',
  ...
  DATE_PART DATE GENERATED ALWAYS AS (DATE(RECORD_LOAD_TIME)) COMMENT 'This is autogenerated from date part of the RECORD_LOAD_TIME column',
  HOUR_PART INT GENERATED ALWAYS AS (HOUR(RECORD_LOAD_TIME)) COMMENT 'This is autogenerated from hour part of the RECORD_LOAD_TIME column'
) USING DELTA PARTITIONED BY (DATE_PART, HOUR_PART) LOCATION 'abfss://catalog@stpsasdi340bdev.dfs.core.windows.net/brnz/T_MT_PHS_DMEM'
TBLPROPERTIES (
  'delta.feature.allowColumnDefaults' = 'supported',
  'delta.feature.appendOnly' = 'supported',
  'delta.feature.invariants' = 'supported',
...
CREATE TABLE IF NOT EXISTS psas_di_dev.340b_brnz.T_DMEM_LIST(
CUST_ACCT_ID STRING,
...
IS_ACTIVE STRING DEFAULT 'Y' COMMENT 'Indicates if the record is active, default is Y',
  ...
  DATE_PART DATE GENERATED ALWAYS AS (DATE(RECORD_LOAD_TIME)) COMMENT 'This is autogenerated from date part of the RECORD_LOAD_TIME column',
  HOUR_PART INT GENERATED ALWAYS AS (HOUR(RECORD_LOAD_TIME)) COMMENT 'This is autogenerated from hour part of the RECORD_LOAD_TIME column'
) USING DELTA PARTITIONED BY (DATE_PART, HOUR_PART) LOCATION 'abfss://catalog@stpsasdi340bdev.dfs.core.windows.net/brnz/T_DMEM_LIST'
TBLPROPERTIES (
  'delta.feature.allowColumnDefaults' = 'supported',
  'delta.feature.appendOnly' = 'supported',
  'delta.feature.invariants' = 'supported',
...
CREATE TABLE IF NOT EXISTS psas_di_dev.340b_brnz.T_MT_WAC_DMEM(
CUST_ACCT_ID STRING, 
LEAD STRING, 
LEAD_NAME STRING,
EXPANSION_ENTITY  STRING,
...
IS_ACTIVE STRING DEFAULT 'Y' COMMENT 'Indicates if the record is active, default is Y',
  ...
  DATE_PART DATE GENERATED ALWAYS AS (DATE(RECORD_LOAD_TIME)) COMMENT 'This is autogenerated from date part of the RECORD_LOAD_TIME column',
  HOUR_PART INT GENERATED ALWAYS AS (HOUR(RECORD_LOAD_TIME)) COMMENT 'This is autogenerated from hour part of the RECORD_LOAD_TIME column'
) USING DELTA PARTITIONED BY (DATE_PART, HOUR_PART) LOCATION 'abfss://catalog@stpsasdi340bdev.dfs.core.windows.net/brnz/T_MT_WAC_DMEM'
TBLPROPERTIES (
  'delta.feature.allowColumnDefaults' = 'supported',
  'delta.feature.appendOnly' = 'supported',
  'delta.feature.invariants' = 'supported',
...
CREATE TABLE IF NOT EXISTS psas_di_dev.340b_brnz.T_MT_LEAD_LIST(
  CNTRCT_LEAD_ID STRING,
  CNTRCT_LEAD_NAME STRING,
  CNTRCT_LEAD_TYPE STRING,
  IS_ACTIVE STRING DEFAULT 'Y'
  COMMENT 'Indicates if the record is active, default is Y',
  _rescued_data STRING
  COMMENT 'Rescued Data',
  ADF_RUN_ID STRING
  COMMENT 'ID for specific pipeline run loaded from landing. This run_id gets generated when the records gets loaded from source to landing',
  ...
  HOUR_PART INT GENERATED ALWAYS AS (HOUR(RECORD_LOAD_TIME))
  COMMENT 'This is autogenerated from hour part of the RECORD_LOAD_TIME column'
) USING DELTA PARTITIONED BY (DATE_PART, HOUR_PART) LOCATION 'abfss://catalog@stpsasdi340bdev.dfs.core.windows.net/brnz/T_MT_LEAD_LIST'
TBLPROPERTIES (
  'delta.feature.allowColumnDefaults' = 'supported',
  'delta.feature.appendOnly' = 'supported',
  'delta.feature.invariants' = 'supported',
...
CREATE TABLE IF NOT EXISTS psas_di_dev.340b_brnz.T_PHS_MEMBERSHIPROSTER_MEMBERS(
 CUST_ACCT_ID STRING,
 CUST_NAME STRING,
 PVP_MEMBER_NAME STRING,
 ...
 IS_ACTIVE STRING DEFAULT 'Y' COMMENT 'Indicates if the record is active, default is Y',
  ...
  DATE_PART DATE GENERATED ALWAYS AS (DATE(RECORD_LOAD_TIME)) COMMENT 'This is autogenerated from date part of the RECORD_LOAD_TIME column',
  HOUR_PART INT GENERATED ALWAYS AS (HOUR(RECORD_LOAD_TIME)) COMMENT 'This is autogenerated from hour part of the RECORD_LOAD_TIME column'
) USING DELTA PARTITIONED BY (DATE_PART, HOUR_PART) LOCATION 'abfss://catalog@stpsasdi340bdev.dfs.core.windows.net/brnz/T_PHS_MEMBERSHIPROSTER_MEMBERS'
TBLPROPERTIES (
  'delta.feature.allowColumnDefaults' = 'supported',
  'delta.feature.appendOnly' = 'supported',
  'delta.feature.invariants' = 'supported',
